...
options = [
  ...
  { question_id: 17, description: 'Drink the water without treating it because you are very thirsty', effects: [-3, 0, 2, 0] },
  ...
  { question_id: 21, description: 'Don\'t eat the snails because you are unsure if they are safe', effects: [0, 0, 0, 0] },
  { question_id: 22, description: 'Catch and cook the frog', effects: [0, 2, 0, 0] },
  { question_id: 22, description: 'Don\'t touch the frog because you don\'t know if it\'s poisonous', effects: [0, 0, 0, 0] },
  ...
  { question_id: 29, description: 'Dig a hole deep enough to allow water to seep in and boil it.', effects: [2, -1, 1, 0] },
  { question_id: 29, description: 'Look for green vegetation and dig behind the first group of sand dunes.', effects: [1, -1, 2, 0] },
  ...
  { question_id: 31, description: 'Cut down a banana or plantain tree and scoop out water from the stump.', effects: [2, -1, 2, 0] },
